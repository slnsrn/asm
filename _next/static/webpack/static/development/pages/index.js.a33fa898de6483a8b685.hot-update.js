...
var returnUsefulInfo = function returnUsefulInfo() {
  return INFO.map(function (info) {
    return __jsx("div", {
      className: "w-1/2 py-4 md:px-6 flex flex-col mb-8",
      __self: _this,
      __source: {
...
var UsefulInformation = function UsefulInformation() {
  return __jsx("div", {
    ...
    className: "font-thin text-5xl md:text-6xl text-center w-full mb-6",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 51,
...
//# sourceMappingURL=index.js.a33fa898de6483a8b685.hot-update.js.map